...
![VMware Workstation Pro](images/VMware-Workstation-Start.png)

2. For **New Virtual Machine Wizard**, select **Typical (recommended)** and click on **Next**

![Typical (recommened)](images/VMware-wizard.png)
...
![Typical (recommened)](images/VMware-wizard2.png)

4. Fill out **Easy Install Information** and select **Next** when ready. 

![Typical (recommened)](images/VMware-wizard3.png)
